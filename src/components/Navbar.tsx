    ...
    <nav className="py-4 px-6 md:px-10 w-full fixed top-0 z-50 bg-game-dark/80 backdrop-blur-md border-b border-gray-800">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-xl font-bold text-white">legacycloud</span>
        </div>
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <a href="#testimonials" className="text-gray-300 hover:text-white transition-colors">review</a>
        </div>

        <div className="hidden md:flex items-center space-x-4">
          <Button variant="outline" className="border-game hover:bg-game/10">Cheappp</Button>
          <Button className="bg-game hover:bg-game/90">easyy</Button>
        </div>
